...
class YoloTRT():
    def __init__(self, library, engine, conf, yolo_ver):
        ...
        # #bestn_full.engine
        # self.categories = ["crosswalk", "noentry", "oneway", "parking", "person", "priority","stop", "trafficlight"]

        #bests_11class.engine
        self.categories = ["crosswalk", "enterHighway", "roundAbout", "noentry", "oneway", "parking", "person", "priority", "stop", "trafficlight", "endHighway", "car"]
        ...
        # print("AAAAAAAAAAAAAAAAAAAAA  Created YOLO TRT")
